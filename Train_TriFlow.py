...
# Directory of malwares (.apk files)
...
# Directory of flows extracted from malwares (.txt files)
...
# Merges benign apps and malwares
...
# Merges benign flows and the ones from malwares
...
print 'Separating real information flows of malwares and benign applications...'
os.mkdir(os.path.join(Home_Dir,'Real_Flows_Benign'))
for app in os.listdir(BenignApps_Dir):
    if '.apk' in app:
        shutil.copy(os.path.join(Home_Dir,'Real_Flows',app + '-realflows.txt'),os.path.join(Home_Dir,'Real_Flows_Benign',app + '-realflows.txt'))
os.mkdir(os.path.join(Home_Dir,'Real_Flows_Malware'))
for app in os.listdir(Malwares_Dir):
    if '.apk' in app:
        shutil.copy(os.path.join(Home_Dir,'Real_Flows',app + '-realflows.txt'),os.path.join(Home_Dir,'Real_Flows_Malware',app + '-realflows.txt'))
...
subprocess.call([sys.executable, os.path.join(Home_Dir,'Frequency.py'), '-i', os.path.join(Home_Dir,'Real_Flows_Benign'), '-o', Output_Dir])
...
# Calculates the frequencies of information flows in malwares
print 'Calculating the frequencies of information flows in malwares...'
subprocess.call([sys.executable, os.path.join(Home_Dir,'Frequency.py'), '-i', os.path.join(Home_Dir,'Real_Flows_Malware'), '-o', Output_Dir])
os.rename(os.path.join(Output_Dir,'Freq_InfoFlows_Sorted.csv'),os.path.join(Output_Dir,'Freq_InfoFlows_Malware.csv'))
print 'Frequency table was created for malwares...'
